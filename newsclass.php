...
<td width="100px"><a href="../admin/index2.php"><img src="../picc/head.png" style="width:100px;height:50px;"/></a></td>
	<td width="100px"><a  href="../admin/index2.php" style="text-decoration:none;color:#000;">首页</a></td>
	...
	while($array=mysql_fetch_array($result1))
	{
		echo
			"<tr align=\"center\" height=\"50px\">
				<td>$array[settime]</td>
				<td><a href=\"../user/newsdetail.php?id=$array[id]\" style=\"text-decoration:none;color:#000;\">$array[title]</a></td>	
...
?>
<br/>
<a href="newsclass.php?page=<?php echo $page-1;?>&newsclass=<?PHP echo $class;?>">上一页&nbsp;</a>
<?php }
for($i=1;$i<=$totalpage;$i++)
	{  
	
?>
<a href="newsclass.php?page=<?php echo $i;  ?>&newsclass=<?PHP echo $class?>" ><?php echo $i,"   "; ?></a>		
<?php
	}
	if($page<$totalpage)
	{
?>
<a href="newsclass.php?page=<?php echo $page+1; ?>&newsclass=<?PHP echo $class?>" >&nbsp;下一页</a>
<?php
	}

...
function display(a){
	...
	if(a=="1"){
	var newsclass="国内新闻"
	var url="../user/newsclass.php?newsclass="+newsclass
...
<td width="100px"><a href="index2.php"><img src="../picc/head.png" style="width:100px;height:50px;"/></a></td>
	<td width="100px" style=" background-color:#A3F173;" ><a  href="index2.php" style="text-decoration:none;color:#000;">首页</a></td>
    ...
    <td width="100px"><a href="../user/userreg.php" style="text-decoration:none;color:#000;" >注册</a></td>
    <td width="100px"><a href="../index.php" style="text-decoration:none;color:#000;">登录</a></td>
</tr>
</table>
</div>
...
<?php
	...
	while($array1=mysql_fetch_array($result1))
	{
		...
		echo
			"<tr align=\"left\">
				<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array1[id]\" style=\"text-decoration:none;color:#000;\">$array1[title]</a></td>
				<td>$array1[hits]</td>
			</tr>"	;
...
<?php
   // error_reporting(E_ALL);
	...
	while($array7=mysql_fetch_array($result7))
	{
		echo
			"<tr align=\"left\">
<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array7[id]\" style=\"text-decoration:none;color:#000;\">$array7[title]</a></td>
			</tr>"	;
...
<?php
   // error_reporting(E_ALL);
	...
	while($array2=mysql_fetch_array($result2))
	{
		echo
			"<tr align=\"left\">				
				<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array2[id]\" style=\"text-decoration:none;color:#000;\">$array2[title]</a></td>
				<td>$array2[hits]</td>
			</tr>"	;
			if($i>=4){
			break;
...
<?php
   // error_reporting(E_ALL);
	...
	while($array8=mysql_fetch_array($result8))
	{
		echo
			"<tr align=\"left\">
<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array8[id]\" style=\"text-decoration:none;color:#000;\">$array8[title]</a></td>
			</tr>"	;
...
<?php
   // error_reporting(E_ALL);
	...
	while($array3=mysql_fetch_array($result3))
	{
		echo
			"<tr align=\"left\">				
				<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array3[id]\" style=\"text-decoration:none;color:#000;\">$array3[title]</a></td>
				<td>$array3[hits]</td>
			</tr>"	;
			if($i>=4){
			break;
...
<?php
	...
	while($array4=mysql_fetch_array($result4))
	{
		echo
			"<tr align=\"left\">				
				<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array4[id]\" style=\"text-decoration:none;color:#000;\">$array4[title]</a></td>
				<td>$array4[hits]</td>
			</tr>"	;
			if($i>=4){
			break;
...
<?php
	...
	while($array5=mysql_fetch_array($result5))
	{
		echo
			"<tr align=\"left\">
<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array5[id]\" style=\"text-decoration:none;color:#000;\">$array5[title]</a></td>
				<td>$array5[hits]</td>
			</tr>"	;
...
<?php
   // error_reporting(E_ALL);
	...
	while($array6=mysql_fetch_array($result6))
	{
		echo
			"<tr align=\"left\">
<td height=\"30px\"><a href=\"../user/newsdetail.php?id=$array6[id]\" style=\"text-decoration:none;color:#000;\">$array6[title]</a></td>
				<td>$array6[hits]</td>
			</tr>"	;
